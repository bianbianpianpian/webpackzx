<template>
  <div id="app">
    <div v-if="CONFIG_ROLE !== null">
      <t-header></t-header>
      <div class="content">
        <!-- <div id="about" v-on:click="about">about</div> -->
...
export default {
  ...
  methods: {
    loadData () {
      ...
      // this.$http.get(CONFIG.URL.querypermcontent, {
      //   params: {
      //     systemid: 'PASSAGEOFTIME'
      //   }
      // }).then(res => {
      //   console.log('ok!!!!', res)
      //   res = res.data
      ...
      //     }
      //     window.CONFIG_ROLE = this.CONFIG_ROLE = tmp
      //     console.log(window.CONFIG_ROLE.PASSAGEOFTIME_STATS_MENU)
      //   }
      // }, res => {
      //   this.$Message.error('获取权限失败!')
      // })
...
<!-- <style lang="scss" src="../static/scss/style.scss"></style> -->
